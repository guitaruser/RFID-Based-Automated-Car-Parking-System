...
class Login:
    def __init__(self,root):
        ...
        # 2D list of users
        self.users = [['user','pass'],['carol','cute'],['External','is dumb']]
        ...
        # Top Title Area
        title_label = tk.Label(frame_login,text='Tarun Login',font=('Helvetica',35,'bold'),bg='White',fg='#005B96')
...
class Admin_work(Login):
    def __init__(self, root):
        ...
        title_label = tk.Label(self.root,text='Choose Any Action',font=('Helvetica',35,'bold'),fg='#005B96')
